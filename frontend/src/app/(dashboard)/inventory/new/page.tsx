      ...
      <form onSubmit={handleSubmit} className="mt-8">
        <div className="bg-surface/5 rounded-lg p-6 md:p-8 space-y-6">
          ...
          <div>
            ...
            <button
              ...
              className="inline-flex items-center gap-2 border border-primary/30 text-primary px-4 py-2.5 rounded font-label text-xs uppercase tracking-widest hover:bg-primary/10 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {aiLoading ? (
                <>
        ...
        <div className="mt-6 flex justify-end">
          <button
            type="submit"
            disabled={submitting}
            className="bg-gradient-to-br from-primary to-primary-container text-white px-8 py-3 rounded font-label text-xs uppercase tracking-widest shadow-[0_4px_20px_-4px_rgba(119,90,25,0.4)] hover:scale-[0.98] transition-all disabled:opacity-50 disabled:cursor-not-allowed"
          >
